...
<body class="body-3">
                        ...
                        <div class="header__right">
                            <div class="header__action d-flex align-items-center">
                                <div class="header__btn-wrap d-none d-sm-inline-flex">
                                    <a href="#" class="rr-btn rr-btn__primary-color">
                                        <span class="btn-wrap">
                                            <span id="button"  class="text-one">Get Appointment</span>
                                            <span id="button" class="text-two">Get Appointment</span>
                                        </span>
                                    </a>
                                </div>
    ...
    <main class="home-3__background overflow-hidden"><!--home-2__background you can remove any time-->
        ...
        <section id="banner" class="banner banner__space overflow-hidden">
            <div class="container">
                <div class="banner__shape" style="background-color: white;">

                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="banner__content text-center">
                            <h1 class="mb-25 mb-xs-20 title-animation" style="perspective: 100px; text-align: left;">
                                Your Trusted Clinic For <br> Comprehensive Wellness
                            </h1>
                            <a href="#" class="rr-btn">
                            ...
                            <div class="banner__media mt-45 mt-xs-35 position-relative">
                                ...
                                <img class="img-fluid"
                                    ...
                                    src="images/banner.jfif" alt="images not found"
                                    style="transform:translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1.069) scaleY(1.069) scaleZ(1.069); -webkit-transform:translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1.069) scaleY(1.069) scaleZ(1.069); ">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="about-us" class="about-us-3 about-us-3__space overflow-hidden" style="">
            <div class="container">
                <div class="about-us-3__background">
                    <div class="about-us-3__shap" data-background="images/about.jfif"></div>
                </div>

                <div id="service" class="service-2 section-space">
                    <div class="container">
                        <div class="row mb-60 mb-xs-50 align-items-lg-end align-items-center">
                            <div class="col-lg-6">
                                <div class="section__title-wrapper mb-md-30 mb-mb-30 mb-xs-30">
                                    ...
                                    <p>An esteemed subsidiary of Platinum Healthcare, setting the pinnacle of unmatched
                                        healthcare excellence in the UAE. Our unwavering commitment reflects in our
                                        delivery of exceptional medical services, infused with genuine empathy. With
                                        seamless integration of U.S. healthcare standards, we ensure our patients in the
                                        UAE receive meticulously tailored treatments backed by the latest in medical
                                        technology.</p>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div
                                    class="service-2__slider__arrow d-flex justify-content-lg-end justify-content-start">
                                    <button
                                ...
                                <div class="swiper service-2__slider mb-minus-60">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="service-2__item">
                                                <a href="#""#" class="service-2__item-media">
                                                    <img class="img-fluid" src="images/about-1.jfif"
                                                        alt="image not found">
                                                </a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="service-2__item">
                                                <a href="#""#" class="service-2__item-media">
                                                    <img class="img-fluid" src="images/about-2.jfif"
                                                        alt="image not found">
                                                </a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="service-2__item">
                                                <a href="#""#" class="service-2__item-media">
                                                    <img class="img-fluid" src="images/about-3.jfif"
                                                        alt="image not found">
                                                </a>
                    ...
                    <div class="container">
                        <div class="service service__space">
                            <div class="container">
                                <div class="row mb-minus-30">
                                    <div class="section__title-wrapper mb-md-30 mb-mb-30 mb-xs-30">
                                        <h3
                                            class="section__subtitle color-theme-primary mb-15 mb-xs-10 title-animation">
                                            Specialties</h3>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="service__item mb-30">
                                            <div class="service__item-icon mb-20 mb-xs-15">
                                                <img src="images/service/service__item-1.png" alt="icon not found">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="service__item mb-30">
                                            <div class="service__item-icon mb-20 mb-xs-15">
                                                <img src="images/service/service__item-2.png" alt="icon not found">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="service__item mb-30">
                                            <div class="service__item-icon mb-20 mb-xs-15">
                                                <img src="images/service/service__item-3.png" alt="icon not found">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="service__item mb-30">
                                            <div class="service__item-icon mb-20 mb-xs-15">
                                                <img src="images/service/service__item-4.png" alt="icon not found">
                                            </div>
        ...
        <!-- specialist-doctor start -->
        <section class="specialist-doctor section-space__bottom">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section__title-wrapper specialist-doctor__content text-center mb-60 mb-xs-30">
                            <h5 class="section__subtitle color-theme-primary mb-15 mb-xs-10 title-animation"><img
                                ...
                                Doctor</h5>
                            <h2 class="section__title mb-0 text-capitalize title-animation">Optimize Oasis Cultivating
                                Health Inspiring Life</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper specialist-doctor__slider">



                <div class="col-12">
                    <div
                        class="swiper service-2__slider mb-minus-60 swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="specialist-doctor__item">

                                    <div class="specialist-doctor__item-media">
                                        <img class="img-fluid" src="images/doctor-1.jfif" alt="image not found">
                                    </div>
                                    <div class="specialist-doctor__item-content">
                                        <div class="specialist-doctor__item-content-text">
                            ...
                            <div class="swiper-slide">
                                <div class="specialist-doctor__item">
                                    ...
                                    <div class="specialist-doctor__item-media">
                                        <img class="img-fluid" src="images/doctor-2.jfif" alt="image not found">
                                    </div>
                                    <div class="specialist-doctor__item-content">
                                        <div class="specialist-doctor__item-content-text">
                                            <h4><a href="#""#">Leslie Alexander</a></h4>
                            ...
                            <div class="swiper-slide">
                                <div class="specialist-doctor__item">
                                    ...
                                    <div class="specialist-doctor__item-media">
                                        <img class="img-fluid" src="images/doctor-3.jfif" alt="image not found">
                                    </div>
                                    <div class="specialist-doctor__item-content">
                                        <div class="specialist-doctor__item-content-text">
                                            <h4><a href="#""#">Leslie Alexander</a></h4>
        ...
        <!-- specialist-doctor end -->

        <!-- client-testimonial area start -->
        <section id="testimonial" class="client-testimonial section-space_test overflow-hidden">
            ...
            <div class="container">
                ...
                <div class="container aos-init aos-animate" data-aos="fade-in">
                    ...
                    <div class="team-says__slider-inner c-pt-lg-4 row justify-content-center">

                        <div class="col-md-6 col-lg-4 c-mt-7 c-mt-md-5 c-mt-lg-0">
                            <div class="h-100">
                                <blockquote class="team-says__single h-100 d-flex flex-column justify-content-between">
                                    <span class="first-element-fix"></span>
                                    <span
                                        class="team-says__quote d-block position-relative text-center text-lg-left text-body-color font-size-16 font-italic line-height-1-7">Lorem
                                        Ipsum
                                    </span>
                                    <cite
                                        class="d-flex flex-column align-items-center flex-lg-row justify-content-lg-start c-mt-7 c-mt-md-5">
                                        <div class="team-says__image-bg rounded-circle position-relative">
                                            <img src="" data-src="" alt=""
                                                class="team-says__image position-relative z-index-2 lazyloaded">
                                        </div>
                                        <div class="team-says__cite text-center text-lg-left">
                                            <span
                                                class="team-says__cite-author d-block text-primary font-size-16 font-weight-semibold">Lorem
                                                ipsum</span>
                                            <span
                                                class="d-block text-body-color line-height-1-4 font-size-14 c-mt-3">Lorem
                                                ipsum</span>
                                        </div>
                                    </cite>
                                </blockquote>
        ...
        <!-- blog area start -->
        <section id="blog" class="blog-3 section-space">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section__title-wrapper blog-3__content text-center mb-60 mb-xs-40">
                            <h5 class="section__subtitle color-theme-primary mb-15 mb-xs-10 title-animation"><img
                                    src="assets/imgs/ask-quesiton/heart.png" alt="icon not found"
                                    class="img-fluid">Latest News</h5>
                            <h2 class="section__title text-capitalize mb-0 title-animation">Health Harmony Your Symphony
                                of Wellbeing</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-minus-30">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-3__item mb-30">
                            ...
                            <div class="blog-3__item-content">
                                ...
                                <h4 class="mt-10 mb-15 text-capitalize"><a href="#""#">Thrive Trail Guiding Your Journey
                                        to Wellness</a></h4>

                                <p class="mb-0">Medical science encompasses a vast array of fields dedi to understanding
                                    and treating ailments, promoting health enhan</p>

                                <a class="rr-a-btn mt-30 d-block" href="blog-details.html">View More <i
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-3__item mb-30">
                            ...
                            <div class="blog-3__item-content">
                                ...
                                <h4 class="mt-10 mb-15 text-capitalize"><a href="#">Essence of Wellness Health
                                        Potential</a></h4>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-3__item mb-30">
                            ...
                            <h4 class=" mt-10 mb-15 text-capitalize"><a href="#">Wellness Weaves Crafting a Tapestry of
                                                Good Health</a></h4>

                                            <p class="mb-0">Medical science encompasses a vast array of fields dedi to
                                                understanding and treating ailments, promoting health enhan</p>
                        ...
                        <div class="swiper brand__active">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid" src="assets/imgs/brand/brand-1.png"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid" src="assets/imgs/brand/brand-2.png"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid" src="assets/imgs/brand/brand-3.png"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid" src="assets/imgs/brand/brand-4.png"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid" src="assets/imgs/brand/brand-5.png"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row mb-minus-50">
                    <div class="col-lg-3 col-6">
                        <div class="footer-3__widget footer-3__widget-item-1">
                            ...
                            <div class="footer-3__content">
                                <p class="mb-0 color-white">Medical practices evolved over millennia, from ancient
                                    civilizations like Egypt and Mesopotamia to the groundbreaking</p>
                            </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="footer-3__widget footer-3__widget-item-3">
                            ...
                            <div class="footer-3__link">
                                <ul>
                                    <li><a href="#">Reliable Rentals</a></li>
                                    <li><a href="#">Golden Key Properties</a></li>
                                    <li><a href="#">Swift Home Sales</a></li>
                                    <li><a href="#">Elite Realty Services</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            ...
                                            <span><i class="fa-solid fa-calendar-days"></i> 17 Oct 2023</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="footer-3__copyright text-lg-start text-center">
                                    <p class="mb-0">© <a href="#">Medilix</a> 2024 | All Rights Reserved</p>
                                </div>
                            </div>
...
.cta__media img {
  -webkit-mask-image: url(../imgs/cta/cta_shape.html);
          mask-image: url(../imgs/cta/cta_shape.html);
  mask-mode: alpha;
...
blockquote.team-says__single.h-100.d-flex.flex-column.justify-content-between {
  background-image: linear-gradient(110deg, #185ec8 20%, rgb(106 155 228) 100%);
